...
success: function(data) {
    ...
    for (var i=0; i<data.length; i++) {
        ...
        var row = $('<tr><td><b><img src="avatar.jpg" width="15px" height="15px" />' + data[i].student + ' :<i> '+ data[i].date + ':</i></b></br><p style="padding-left:80px">' + data[i].post + '</br><a data-toggle="modal" data-id="'+ commentId +'" title="Add this item" class="open-ReplyModal" href="#ReplyModal">Reply</a>'+'</p></td></tr>');
        $('#record').append(row);
